...
const carDetails = Object.assign({}, car, features)

console.log(`Автомобиль: ${carDetails.brand} ${carDetails.model}, год: ${carDetails.year}, цвет: ${carDetails.color}, электрический: ${carDetails.isElectric ? 'да' : 'нет'}, владелец: ${carDetails.owner}.`);